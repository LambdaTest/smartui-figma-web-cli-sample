# Run SmartUI Visual Tests with Figma Web CLI on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run SmartUI visual regression tests with Figma designs on the TestMu AI cloud. This sample shows how to configure Figma + SmartUI CLI to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/smartui-figma-web-cli-sample && cd smartui-figma-web-cli-sample
...
```bash
smartui figma --config smartui-figma.json
```
